...
spacemode()
#=======================출석창 접근====================================
acc_atten_link = driver.find_element_by_css_selector('#mainContent > div.container2.online_tab > nav > ul > li:nth-child(3) > a')
acc_atten_link.click()
time.sleep(2)
'''
...
if todate in chetext: #출석 성공
	...
	print('로그아웃중...')
	spacemode()
	driver.get("https://hoc5.ebssw.kr/sso?c=LO&amp;returnUrl=https://hoc5.ebssw.kr:443/soraehigh303") #로그아웃 링크
	print('출석 프로그램 종료')
	driver.quit()
else : #출석 실패
	print('날짜 틀림')
